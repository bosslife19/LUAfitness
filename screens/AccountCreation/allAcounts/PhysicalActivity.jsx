      ...
      {questions.map((question, index) => (
        <View key={index} style={styles.questionContainer}>
          ...
          <View style={styles.checkboxContainer}>
            ...
            >
              <View style={[styles.checkbox, answers[question] === "Yes" && styles.checkedBox]}>
                {answers[question] === "Yes" && <Ionicons name="checkmark" size={10} color="white" />}
              </View>
            ...
            >
              <View style={[styles.checkbox, answers[question] === "No" && styles.checkedBox]}>
                {answers[question] === "No" && <Ionicons name="checkmark" size={10} color="white" />}
              </View>
